...
export const KNOWN_SESSION_EVENT_TYPES: ReadonlySet<string> = new Set([
  ...
  'governance/decision',
  'governance/delegate',
  'governance/delegation-cancelled',
  'governance/delegation-failed',
  'governance/delegation-progress',
  'governance/delegation-start',
  'governance/file-change-summary',
  'governance/handoff',
  'governance/harness',
  'governance/harness-check',
  'governance/harness-registered',
  'governance/report',
  'governance/route',
