...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SnapshotId: 'snapshot identity is owned by packages/fs/snapshot/src/types.ts',
  SnapshotInfo: 'snapshot summary record is owned by packages/fs/snapshot/src/types.ts',
  SnapshotCreateOptions: 'snapshot creation input is owned by packages/fs/snapshot/src/types.ts',
  SnapshotRestoreOptions: 'snapshot restore input is owned by packages/fs/snapshot/src/types.ts',
  SnapshotDiffOptions: 'snapshot diff input is owned by packages/fs/snapshot/src/types.ts',
  SnapshotDiff: 'snapshot diff result is owned by packages/fs/snapshot/src/types.ts',
  SnapshotRestoreOutcome: 'snapshot restore result is owned by packages/fs/snapshot/src/types.ts',
