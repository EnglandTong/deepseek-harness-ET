...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  supervisor: 'subagent.md',
  supervisorApi: 'subagent.md',
  supervisorExecutors: 'subagent.md',
  supervisorInteraction: 'subagent.md',
  supervisorMemory: 'subagent.md',
  supervisorOrchestrator: 'subagent.md',
  supervisorProjectHost: 'subagent.md',
  supervisorProjectRegistry: 'subagent.md',
  supervisorSession: 'subagent.md',
}
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SupervisorIdentityEvent: 'event-local envelope is owned by packages/supervisor/supervisor/src/events.ts',
  SupervisorProjectEvent: 'event-local envelope is owned by packages/supervisor/supervisor/src/events.ts',
  SupervisorTaskEvent: 'event-local envelope is owned by packages/supervisor/supervisor/src/events.ts',
  SupervisorRunLinkedEvent: 'event-local envelope is owned by packages/supervisor/supervisor/src/events.ts',
  SupervisorPolicyAppliedEvent: 'event-local envelope is owned by packages/supervisor/supervisor/src/events.ts',
  SupervisorNotificationEvent: 'event-local envelope is owned by packages/supervisor/supervisor/src/events.ts',
  ProjectCandidate: 'project discovery input is owned by packages/supervisor/supervisor-project-registry/src/index.ts',
  ProjectDiscoveryOptions: 'project discovery options are owned by packages/supervisor/supervisor-project-registry/src/index.ts',
  RegisteredProject: 'registered project projection is owned by packages/supervisor/supervisor-project-registry/src/index.ts',
  SupervisorApiTask: 'Host API task projection is owned by packages/supervisor/supervisor-api/src/types.ts',
  SupervisorApprovalBatch: 'approval batch projection is owned by packages/supervisor/supervisor-orchestrator/src/types.ts',
  SupervisorCaptureRequest: 'orchestrator intake is owned by packages/supervisor/supervisor-orchestrator/src/types.ts',
  SupervisorCaptureResult: 'orchestrator intake result is owned by packages/supervisor/supervisor-orchestrator/src/types.ts',
  SupervisorDispatchResult: 'dispatch result is owned by packages/supervisor/supervisor-orchestrator/src/types.ts',
  SupervisorEvent: 'event union is owned by packages/supervisor/supervisor/src/events.ts',
  SupervisorExecutionHandle: 'executor handle is owned by packages/supervisor/supervisor-executor-subagent/src/types.ts',
  SupervisorExecutionRequest: 'executor request is owned by packages/supervisor/supervisor-executor-subagent/src/types.ts',
  SupervisorExecutor: 'executor registration is owned by packages/supervisor/supervisor/src/providers.ts',
  SupervisorExecutorProvider: 'executor provider is owned by packages/supervisor/supervisor-executor-subagent/src/types.ts',
  SupervisorFollowUpRequest: 'follow-up request is owned by packages/supervisor/supervisor-orchestrator/src/types.ts',
  SupervisorGovernanceMemory: 'governance memory is owned by packages/supervisor/supervisor-memory/src/types.ts',
  SupervisorIdentitySnapshot: 'identity snapshot is owned by packages/supervisor/supervisor/src/types.ts',
  SupervisorIdType: 'branded Supervisor identity is owned by packages/supervisor/supervisor/src/types.ts',
  SupervisorIntakeRequest: 'interaction intake is owned by packages/supervisor/tool-supervisor/src/types.ts',
  SupervisorIntakeResult: 'interaction intake result is owned by packages/supervisor/tool-supervisor/src/types.ts',
  SupervisorInteractionNotification: 'interaction notification is owned by packages/supervisor/tool-supervisor/src/types.ts',
  SupervisorMemoryProjection: 'memory projection is owned by packages/supervisor/supervisor-memory/src/types.ts',
  SupervisorMemoryRecord: 'memory record is owned by packages/supervisor/supervisor-memory/src/types.ts',
  SupervisorNotification: 'notification snapshot is owned by packages/supervisor/supervisor/src/types.ts',
  SupervisorNotificationListener: 'notification listener is owned by packages/supervisor/supervisor-orchestrator/src/types.ts',
  SupervisorProjectHostSnapshot: 'project host snapshot is owned by packages/supervisor/supervisor-project-host/src/types.ts',
  SupervisorProjectId: 'branded project identity is owned by packages/supervisor/supervisor/src/types.ts',
  SupervisorProjectProvider: 'project provider is owned by packages/supervisor/supervisor/src/providers.ts',
  SupervisorProjectSnapshot: 'project snapshot is owned by packages/supervisor/supervisor/src/types.ts',
  SupervisorQueryBrief: 'query brief is owned by packages/supervisor/supervisor-memory/src/types.ts',
  SupervisorReporter: 'reporter registration is owned by packages/supervisor/supervisor/src/providers.ts',
  SupervisorRollingSummary: 'rolling summary is owned by packages/supervisor/supervisor-memory/src/types.ts',
  SupervisorRouter: 'router registration is owned by packages/supervisor/supervisor/src/providers.ts',
  SupervisorRunAdmissionRequest: 'run admission request is owned by packages/supervisor/supervisor-project-host/src/types.ts',
  SupervisorRunId: 'branded run identity is owned by packages/supervisor/supervisor/src/types.ts',
  SupervisorRunLease: 'run lease is owned by packages/supervisor/supervisor-project-host/src/types.ts',
  SupervisorRunLink: 'run link is owned by packages/supervisor/supervisor/src/types.ts',
  SupervisorRunRecovery: 'run recovery is owned by packages/supervisor/supervisor-project-host/src/types.ts',
  SupervisorRunResult: 'run result is owned by packages/supervisor/supervisor-orchestrator/src/types.ts',
  SupervisorStatusResponse: 'Host API status projection is owned by packages/supervisor/supervisor-api/src/types.ts',
  SupervisorStatusView: 'interaction status projection is owned by packages/supervisor/tool-supervisor/src/types.ts',
  SupervisorTaskId: 'branded task identity is owned by packages/supervisor/supervisor/src/types.ts',
  SupervisorTaskSnapshot: 'task snapshot is owned by packages/supervisor/supervisor/src/types.ts',
}
