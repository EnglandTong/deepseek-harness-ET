...
Source: [`packages/supervisor/supervisor/src/types.ts:134`](../packages/supervisor/supervisor/src/types.ts)

<a id="deepseek-aidsh-supervisor-memory"></a>

## `@deepseek-ai/dsh-supervisor-memory`

Requires: `supervisor` · `supervisorSession`
...
Source: [`packages/supervisor/supervisor-memory/src/types.ts:104`](../packages/supervisor/supervisor-memory/src/types.ts)

<a id="deepseek-aidsh-supervisor-orchestrator"></a>

## `@deepseek-ai/dsh-supervisor-orchestrator`

Requires: `supervisor` · `supervisorExecutors` · `supervisorSession`
...
Source: [`packages/supervisor/supervisor-orchestrator/src/types.ts:10`](../packages/supervisor/supervisor-orchestrator/src/types.ts)
...
Source: [`packages/supervisor/supervisor-project-registry/src/types.ts:43`](../packages/supervisor/supervisor-project-registry/src/types.ts)
...
Requires: `commands` · `agents` · `supervisor` · `supervisorSession` · `supervisorOrchestrator` · `supervisorProjectRegistry`
...
Source: [`packages/supervisor/tool-supervisor/src/index.ts:39`](../packages/supervisor/tool-supervisor/src/index.ts)
...
- `@deepseek-ai/dsh-supervisor-api` — requires `supervisor` · `supervisorOrchestrator` · `supervisorSession` ([`packages/supervisor/supervisor-api/src/index.ts`](../packages/supervisor/supervisor-api/src/index.ts))
- `@deepseek-ai/dsh-supervisor-executor-subagent` — requires `supervisorProjectHost` ([`packages/supervisor/supervisor-executor-subagent/src/index.ts`](../packages/supervisor/supervisor-executor-subagent/src/index.ts))
- `@deepseek-ai/dsh-supervisor-project-host` — requires `sessions` · `sessionPersistence` · `supervisor` ([`packages/supervisor/supervisor-project-host/src/index.ts`](../packages/supervisor/supervisor-project-host/src/index.ts))
- `@deepseek-ai/dsh-supervisor-session` — requires `settings` · `sessions` · `sessionPersistence` · `supervisor` ([`packages/supervisor/supervisor-session/src/index.ts`](../packages/supervisor/supervisor-session/src/index.ts))
